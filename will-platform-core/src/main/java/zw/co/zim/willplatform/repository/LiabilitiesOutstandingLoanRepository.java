...
public interface LiabilitiesOutstandingLoanRepository extends JpaRepository<LiabilitiesOutstandingLoan, Long> {
    List<LiabilitiesOutstandingLoan> findAllByRecordStatusNot(Pageable pageable, RecordStatus recordStatus);

    List<LiabilitiesOutstandingLoan> findAllByUserIdAndRecordStatusNot(Pageable pageable, Client clientId, RecordStatus recordStatus);
