...
public interface WillDocumentsRepository extends JpaRepository<WillDocuments, Long> {
    List<WillDocuments> findAllByRecordStatusNot(RecordStatus recordStatus);
