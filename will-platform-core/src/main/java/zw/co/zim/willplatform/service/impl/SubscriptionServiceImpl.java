...
import zw.co.zim.willplatform.repository.SubscriptionRepository;
import zw.co.zim.willplatform.service.SubscriptionService;
...
public class SubscriptionServiceImpl implements SubscriptionService {
    ...
    public void deleteById(Long id) {
        Optional<Subscription> optional = this.findById(id);
    ...
    @Override
    public Page<Subscription> findAll(Integer pageNo, Integer pageSize) {
    ...
    @Override
    public Optional<Subscription> findFirstByUserId(Client userId) {
