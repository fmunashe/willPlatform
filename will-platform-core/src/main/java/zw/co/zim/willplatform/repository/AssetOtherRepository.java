...
public interface AssetOtherRepository extends JpaRepository<AssetOther, Long> {
    List<AssetOther> findAllByRecordStatusNot(Pageable pageable, RecordStatus recordStatus);

    List<AssetOther> findAllByUserIdAndRecordStatusNot(Pageable pageable, Client clientId, RecordStatus recordStatus);
